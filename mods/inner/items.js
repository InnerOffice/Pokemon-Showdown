...
let BattleItems = {
	...
	"absorbbulb": {
		...
		num: 545,
		gen: 5,
		desc: "Raises holder's Sp. Atk by 1 stage if hit by a Water-type attack.",
	},
	"adamantorb": {
		id: "adamantorb",
		name: "Adamant Orb",
	...
	"deepseascale": {
		...
		onModifySpD: function (spd, pokemon) {
			if (pokemon.baseTemplate.baseSpecies === 'Clamperl' || pokemon.baseTemplate.baseSpecies === 'Gorebyss') {
	...
	"deepseatooth": {
		...
		onModifySpA: function (spa, pokemon) {
			if (pokemon.baseTemplate.baseSpecies === 'Clamperl' || pokemon.baseTemplate.baseSpecies === 'Huntail') {
				return this.chainModify(2);
			}
		},
		num: 226,
	...
	"moonstone": {
		...
		onModifySpDPriority: 1,
		onModifySpD: function (spd, pokemon) {
			if (user.baseTemplate.species === 'Lunatone'  || pokemon.baseTemplate.baseSpecies === 'Lunala') {
				return this.chainModify(2);
			}
		},
		onModifyDefPriority: 2,
	...
	"protector": {
		...
		onModifySpDPriority: 1,
		onModifySpD: function (spd, pokemon) {
			if (user.baseTemplate.species === 'Rhyperior') {
				return this.chainModify(2);
			}
		},
		num: 321,
	...
	"sachet": {
		...
		onModifySpAPriority: 1,
		onModifySpA: function (spa, pokemon) {
			if (user.baseTemplate.species === 'Aromatisse') {
				return this.chainModify(2);
			}
		},
		num: 647,
	...
	"sunstone": {
		...
		onModifySpDPriority: 1,
		onModifySpD: function (spd, pokemon) {
			if (user.baseTemplate.species === 'Solrock'  || pokemon.baseTemplate.baseSpecies === 'Solgaleo') {
				return this.chainModify(2);
			}
		},
		onModifyDefPriority: 2,
	...
	"whippeddream": {
		...
		onModifyAtkPriority: 1,
		onModifyAtk: function (atk, pokemon) {
			if (user.baseTemplate.species === 'Slurpuff') {
				return this.chainModify(2);
			}
		},
		num: 646,
